...
void initmyreaderBDT(TTree* tree)
{
    ...
    myreaderBDT->BookMVA("BDT","/afs/cern.ch/user/s/ssaumya/Projects/WW_Analysis_Work/WW_Cuts_Optimization/CMSSW_11_1_3/src/PlotsConfigurations/Configurations/WW/FullRunII/Full2017_v7/BDT_Training_weights_v2/2jet/TMVAClassification_BDTG4D3.weights.xml"); 
